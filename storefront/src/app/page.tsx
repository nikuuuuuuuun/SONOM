    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="bg-gradient-to-br from-sonom-primary to-sonom-text py-24 text-center text-white">
          <div className="mx-auto max-w-4xl px-4">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-white/60">
              Piezas unicas hechas a mano por artesanos mexicanos, capturando la
              esencia de los personajes que han marcado nuestra historia y cultura.
            </p>
            <Link
              href="/productos"
              className="inline-block rounded-full bg-sonom-accent px-8 py-3 text-lg font-semibold text-sonom-text hover:bg-yellow-400 transition-colors"
            >
              Explorar coleccion
            </Link>
          </div>
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <h2 className="mb-12 text-center text-3xl font-bold text-sonom-text">
            Categorias
          </h2>
        ...
        <section className="bg-sonom-text/5 py-20">
          <div className="mx-auto max-w-4xl px-4 text-center">
            <h2 className="mb-6 text-3xl font-bold text-sonom-text">
              Hecho a mano con tradicion
            </h2>
            <p className="text-lg text-sonom-muted">
